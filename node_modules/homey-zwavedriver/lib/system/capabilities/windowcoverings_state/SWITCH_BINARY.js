...
/**
 * Based on the windowcoverings_state value this method calculates and stores the corresponding
 * SWITCH_BINARY value, taking into account the possible invertWindowCoveringsDirection setting.
...
function determineAndSaveState(value) {
  ...
  switch (value) {
    ...
    case 'down':
      ...
      break;
    default:
      this.error('Error: could not determine and save state for unknown value', { value });
  }
 ...
 * 'invertWindowCoveringsDirection' setting (see zwave/system/settings.json), this will be used
