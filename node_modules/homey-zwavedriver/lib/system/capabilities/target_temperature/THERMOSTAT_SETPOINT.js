...
/**
 * Capability target_temperature i.c.w. the THERMOSTAT_SETPOINT command class takes an
 * additional variable (this.thermostatSetpointType) which can determine on runtime the setpoint
 * type to use.
 */
module.exports = {
