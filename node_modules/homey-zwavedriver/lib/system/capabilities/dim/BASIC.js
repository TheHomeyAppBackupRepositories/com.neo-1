...
module.exports = {
  ...
  reportParserV1(report) {
    if (report && report.hasOwnProperty('Value')) {
      if (this.hasCapability('onoff')) this._setCapabilityValueSafe('onoff', report['Value'] > 0);
  ...
  reportParserV2(report) {
    if (report && report.hasOwnProperty('Current Value')) {
      if (this.hasCapability('onoff')) this._setCapabilityValueSafe('onoff', report['Current Value'] > 0);
